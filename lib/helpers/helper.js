...
let currsafeMultiplier = new Array(3); //array for the 3 distinct multiplier
let currSafeImage = new Array(3); //array for 3 distinct images
...
export function create_safes() {
    ...
    for (let i = 0; i < cols; i++) {
        for (let j = 0; j < rows; j++) {
            ...
            }, "../graphics/safe_minigame.png", mul, ++count, currSafeImage[currsafeMultiplier.indexOf(mul)], {
                x: safe_width,
                y: safe_height
            }));
        }
